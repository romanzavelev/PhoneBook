 ...
 */
/*
1) ’ранить данные в виде массива
2) ћассив должен мен€ть свой размер при добавлении и удалении элементов
3) ƒобавление контакта, удаление контакта по имени, вставка по индексу, получение контакта по индексу
 */
...
public void sort(){
    //1. —ортировка по первой букве (учет регистра)
    //2. —ортировка по всему имени
    /*
    Alex
    alexandr
    alexey
